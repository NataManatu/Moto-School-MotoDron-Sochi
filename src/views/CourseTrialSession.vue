            ...
            <div class="course-a-content">
                ...
                <div class="course-card">
                    <div class="nav-course">
                        <p><router-link to="/"><span>Главная</span></router-link> / Пробное занятие
                        </p>
                    </div>
                    <div class="about-course">
                        <p id="cont-p-1">Пробное занятие</p>

                        <p id="cont-p-2">Инструктаж + практика для тех, кто пока не определился, какой курс выбрать и
                            хочется ли вообще становиться учеником нашей мотошколы. Курс – также тест-драйв
                            для новичков, которые впервые садятся за руль и хотят понять, как это – управлять мотоциклом
                        </p>
                        <ul>
        ...
        <div class="this-course-container">
            ...
            <div class="this-course-content">
                ...
                <div class="course-a-grid">
                    <div class="course-a-item"><img src="@/assets/img-CourseTrialSession/WhoCard01.png" alt=""></div>
                    <div class="course-a-item"><img src="@/assets/img-CourseTrialSession/WhoCard02.png" alt=""></div>
                    <div class="course-a-item"><img src="@/assets/img-courseTrialSession/WhoCard03.png" alt=""></div>
                    <div class="course-a-item"> <img src="@/assets/img-courseTrialSession/WhoCard04.png" alt=""></div>
                </div>
        ...
        <div class="program-course-container">
            ...
            <div class="program-course-content">
                <div class="programm-item-box">
                    <p class="pr-bl">1</p>
                    <p class="pr-p">Знакомимся с вашими<br>желаниями и задачами</p>
                </div>
                <div class="programm-item-box">
                    <p class="pr-bl">2</p>
                    <p class="pr-p">Полный инструктаж по мотоциклу</p>
                </div>
                <div class="programm-item-box">
                    <p class="pr-bl">3</p>
                    <p class="pr-p">Вождение: упражнения<br>на баланс</p>
                </div>
                <div class="programm-item-box">
                    <p class="pr-bl">4</p>
                    <p class="pr-p">Тренировка базовых навыков<br>управления мотоциклом</p>
                </div>
            </div>
        </div>
            ...
            <div class="result-content">
                <div class="result-text-content">
                    <div class="result-box">
                        ...
                        <p>Сможете понять, готовы ли дальше<br>обучаться вождению мотоцикла</p>
                    </div>
                    <div class="result-box">
                        <img src="@/assets/img-courseA/Vector.svg" alt="">
                        <p>Подберете подходящий<br>себе курс обучения</p>
                    </div>
                    <div class="result-box">
                        <img src="@/assets/img-courseA/Vector.svg" alt="">
                        <p>И готовы ли делать<br>это в нашей школе</p>
                    </div>
                    <div class="result-box">
                        <img src="@/assets/img-courseA/Vector.svg" alt="">
                        <p>Ближе познакомитесь с нашим<br>подходом в обучении</p>
                    </div>
...
<style scoped>
@import url(../assets/CourseTrialSession.css);
</style>
