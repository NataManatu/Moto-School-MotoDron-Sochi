            ...
            <div class="quest-block">
                <div class="quest-text">
                    <ul>
                        ...
                        <li>Выдаете ли вы экипировку на время занятий на площадке?</li>
                        <li id="li-lh">Нужна ли регистрация и гражданство,чтобы учиться и сдавать экзамены на категорию ”А”?</li>
