                    ...
                    <div class="quest-text">
                        ...
                        <ul>
                            ...
                            <div class="quest-box-2">
                                <p>
                                    Мы можем заключить договор сразу и приступить к практическим занятиям.<br> Но пока
                                    вы не
                            ...
                            <div class="quest-box-3">
                                <p>
                                    Каждое занятие длится 90 минут.<br><br>Длительность обучения зависит от выбранного
                                    курса,
                                    ваших задач и возможностей. <br><br>Например, для подготовки к экзамену в ГИБДД с
                                    нуля
                                    понадобится 10 занятий, плюс теория онлайн.<br><br>По законодательству для получения
                                    прав
                            ...
                            <div class="quest-box-9">
                                <p>
                                    Да, в стоимость обучения на любом курсе входит полный комплект экипировки и защиты.
                                    Ваша безопасность – наш приоритет.
                                </p>
                            </div>
