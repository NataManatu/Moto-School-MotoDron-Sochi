    ...
    <div class="container">
            ...
            <div class="about-text-img">
                ...
                <div class="about-text">
                    <p>Наши инструкторы имеют огромный опыт как в управлении мототехникой, так и в обучении
                        мотоциклистов. А
                        постоянное повышение своих навыков инструкторами даст вам возможность узнать что-то новое даже
                        если
                    ...
                    <p> Наши инструкторы имеют огромный опыт как в управлении мототехникой, так и в обучении
                        мотоциклистов.
                        А постоянное повышение своих навыков инструкторами даст вам возможность узнать что-то новое даже
                ...
                <div class="why-text-block">
                    ...
                    <div class="block-2">
                        ...
                        <p id="text">Тщательная проработка всех без исключения ошибок учеников, а если точнее
                            бескомпромисное
                            отношение к ним, не оставит вам шанса на провал в постижении искусства управления мотоциклом
                            и сдаче экзаменов.</p>
                    </div>
                    <div class="block-3">
                        ...
                        <p id="text">Вы сами назначаете время каждой тренировки тогда, когда удобно вам. Не будет
                            никаких
                            пропущеных занятий, потраченных впустую денег (потому что вы не смогли прийти). Тренировка
                            раз в неделю? - пожалуйста, каждый день? - не вопрос, три дня подряд и перерыв две недели? -
                            так тоже можно.</p>
                    </div>
                    <div class="block-4">
                        <img src="@/assets/img-why-bl-3/04.svg" alt="" id="why-svg">
                        <p id="title">ИНДИВИДУАЛЬНЫЙ<br> ПОДХОД</p>
                        <p id="text">Тренировки проводятся только в индивидуальном режиме. Никаких групповых занятий.
                            Всё время
        ...
        <div class="course">
            ...
            <div class="content-vector">
                <button @click="butVect1" class="but_vect1"><div id="vector-1"><img src="@/assets/img-course-bl-4/Vector 10.png" alt=""></div></button>
                <button @click="butVect2" class="but_vect2"><div id="vector-2"><img src="@/assets/img-course-bl-4/Vector 10 (1).png" alt=""></div></button>
            </div>
                ...
                <article class="course-program-card">
                    ...
                    <div class="course-text">
                        ...
                        <p>Предназначен для желающих максимально ознакомиться с устройством мотоцикла. Получить
                            начальные навыки безопасного управления мотоциклом на малых и средних скоростях. Отработать
            ...
            <div class="entry-content">
                ...
                <div class="entry-block ">
                    <p>Пробное занятие в нашей школе абсолютно<br> бесплатное, без скрытых платежей и сборов на
                        бензин.<br>
                        Также посещение пробного занятия не обязывает вас<br> покупать какой-либо курс и не входит в его
                        стоимость.
                    </p>
        ...
        <div class="bee-moto">
            ...
            <div class="bee-moto-content-2">
                <img src="@/assets/img-bee-moto-bl-6/sunset-motorcycle-acrobatics-silhouette 1 (1).png" alt="" id="be-img-1">
            ...
            <div class="bee-moto-border-text">
                ...
                <div class=" t-text-author">
                    <p id="autor">Человек, оседлавший мотоцикл, может сконцентрироваться только на очередной секунде
                        ...
                        выдернут из
                        непрерывности времени; он вне его; иначе говоря, он находится в состоянии экстаза, он ничего не
                        знает ни о
                        своем возрасте, ни о своей жене, детях, заботах и, следовательно, ничего не боится, ибо источник
        ...
        <div class="command">
            ...
            <img src="@/assets/img-command-bl-9/BG.png" alt="" id="bg-1">
            ...
            <div class="instructor-card">
                <div class="text-card">
                    ...
                    <p id="instructor-text-p-3">Легкий индийский дорожный мотоцикл. Имеет классический дизайн с
                        ...
                        деталей.Выносливый и эффективный, что делает его отличным мотоциклом для городских и длительных
                        поездок по пересеченной местности.<br><br>
                        Сочетание стильного дизайна и превосходных технических характеристик порадуют как новичка, так и
            ...
            <img src="@/assets/img-command-bl-9/BG-2.png" alt="" id="bg-2">
            ...
            <div class="news-box">
                ...
                <article class="news-program-card">
                    ...
                    <div class="news-text">
                        ...
                        <div class="overflow-text">
                            <p id="news-text">Индийский мотопроизводитель Hero MotoCorp инвестирует внушительную сумму в
                    ...
                    <div class="news-text">
                        ...
                        <div class="overflow-text">
                            <p id="news-text">Самая главная причина, к которой сводятся вышеперечисленные —
                                ...
                                мотоциклом, заставляет их совершенствовать навыки, работать над собой. Удовольствие от
                                открытий и путешествий, заставляют их планировать все новые и новые маршруты, делиться
                                находками. Удовольствие самореализации в мотоспорте или мотокультуре, радость общения с
